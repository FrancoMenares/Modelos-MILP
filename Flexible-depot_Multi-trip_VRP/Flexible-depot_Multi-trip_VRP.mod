...
set A0 := {i in D_start, j in D_in : i+10000 == j} ; # CONJUNTO DE ARCO RELACIONALES ENTRE DEPOSITO INICIAL E INTERMEDIO (RELACIÓN UNO A UNO)
...
set A4 := {i in D_in, j in D_end : i+90000 == j}; # CONJUNTO DE ARCOS DEPOSITO_INTERMEDIO-DEPOSITO_FINAL
